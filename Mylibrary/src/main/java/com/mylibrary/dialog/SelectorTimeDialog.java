...
import com.mylibrary.utils.CommonUtils;
...
public class SelectorTimeDialog {
    ...
    public SelectorTimeDialog(Context context, OnResultHandler resultHandler, String startDate, String endDate) {
        ...
        startCalendar.setTime(FormatUtils.getFormatDateStr(startDate, FORMAT_STR));
        endCalendar.setTime(FormatUtils.getFormatDateStr(endDate, FORMAT_STR));
    ...
    private void initView() {
        ...
        tv_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String date = FormatUtils.getFormatDate(selectedCalender.getTime(), FORMAT_STR);
                if (mode != null) {
                    switch (mode.value) {
                        case 1:
                            date = FormatUtils.getFormatDate(selectedCalender.getTime(), "yyyy-MM-dd");
                            break;
                        case 3:
                            date = FormatUtils.getFormatDate(selectedCalender.getTime(), "HH:mm");
                            break;
                    }
                }
                handler.handle(date);
...
//                }
    ...
    public void setSelectDate(String dateStr) {
        ...
        selectedCalender.setTime(FormatUtils.getFormatDateStr(dateStr, FORMAT_STR));
    }
