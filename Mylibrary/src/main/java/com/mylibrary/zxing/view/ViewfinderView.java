...
//			paint.setAlpha(0x40);
            ...
            int top = frame.left;
            if (screenResolution.x > textWidth) {
                top = (int) (screenResolution.x - textWidth) / 2;
            }
            canvas.drawText(getResources().getString(R.string.scan_text), top, (float) (frame.bottom + (float) TEXT_PADDING_TOP * density), paint);
