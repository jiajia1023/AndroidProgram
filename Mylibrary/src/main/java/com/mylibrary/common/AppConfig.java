...
//    public static final String REMOTE_DATA_TYPE = "json";
    ...
    // log
    public static final String LOG_TAG = "giftday_android";
    public static final boolean LOG_CLOSED = false;

    //QQ
    public static final String QQ_APPID = "1106067492";
    public static final String QQ_APPKEY = "Xoh4xHKOtbfxwj92";

    //weixin
    public static final String WX_APPID = "wx7b2f5278bbf5d8f0";
    public static final String WX_APPSECRET = "7bd8d5ac646f6e1d050bea6b85b4a3c3";
    //sina
    public static final String SINA_APPID = "c84a348379cb838046268e6da392f720";
    public static final String SINA_APPKEY = "c84a348379cb838046268e6da392f720";
    public static final String SINA_NETURL = "c84a348379cb838046268e6da392f720";

    //JPush
    public static final String JPUSH_APPKEY = "4e7ca6724b6d429a01fa2018";
    public static final String JPUSH_SERCERT = "657ae8edd29de45b34c70b95";

    //支付宝
    public static final String ZFB_URL = "http://hptree.cn";
